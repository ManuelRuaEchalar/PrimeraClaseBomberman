...
#define UE_PROJECT_NAME PrimeraClase
#define UE_TARGET_NAME PrimeraClaseEditor
#define UE_MODULE_NAME "PrimeraClase"
...
#define PRIMERACLASE_API DLLEXPORT
